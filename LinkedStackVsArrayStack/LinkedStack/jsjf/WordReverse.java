...
public class WordReverse {
    public static void main(String[] args) {
        ...
        /**
         * Instantiates the LinkedStack with a character array type
         */
        LinkedStack<char[]> words = new LinkedStack<>();
        System.out.println("Enter a sentence to reverse the words: ");
        sentence = scanner.nextLine();
        sentence += " ";

        /**
         * Adds to a LinkedStack using character arrays of each word.
         */
        ...
        /**
         * Pops each character array from the LinkedStack and reverses it.
